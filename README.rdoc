...
and any version of actionmailer since 1.3.6 (the version used by rails 1.2.6), including 3.0.0.beta.  The 1.8.6 and 1.8.7 builds (linked to above)
use {ginger}[http://github.com/freelancing-god/ginger] to run the specs against 16 different versions of actionmailer.
Unfortunately, ginger doesn't appear to work on ruby 1.9.1 yet.
